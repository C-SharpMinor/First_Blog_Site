				...
				<Sidebar.ItemGroup className="flex flex-col gap-1">
					{currentUser && currentUser.isAdmin && (
						<Link to="/dashboard?tab=dash">
							{/* //when do you put {""} when writing the link path and when do you put just '' */}
							<Sidebar.Item
								active={tab === "dash" || !tab}
								icon={HiChartPie}
								as="div"
					...
					{/* for the above you should be able to put all the LinkItems in one 
					{currentUser.isAdmin && (...
					you'll just need to use <> </> to house all the different LinkItems */}
